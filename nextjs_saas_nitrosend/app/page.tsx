...
import { nitrosendEmailConfigured } from '@/lib/nitrosend-config';
          ...
          <ul className="relative grid w-full grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3">
            ...
            <li className="relative">
              {nitrosendEmailConfigured ? (
                ...
                >
                  <div className="relative">
                    <img alt="" className="inline-block h-8 w-8 rounded-sm" src="/icons/nitrosend.svg" />
                    <div className="mb-1.5 mt-3 flex items-center gap-2">
                      <h3 className="text-lg font-medium text-neutral-950">Nitrosend Email</h3>
                      <StatusBadge label="Configured" tone="configured" />
                    </div>
                    <p className="mb-3 text-pretty text-neutral-600">
                      Nitrosend sends the welcome, trial-ending and payment-failed emails from your hosted sender, and its MCP server writes campaigns and flows for you.
                    </p>
                  </div>
                  <div className="flex items-center gap-1 font-medium">
                    Open Nitrosend
                ...
                <div className="relative flex h-full flex-col rounded-md border border-neutral-950/10 p-6">
                  <div className="relative">
                    ...
                    <p className="mb-3 text-pretty text-neutral-600">
                      Nitrosend sends the lifecycle emails (welcome, trial ending, payment failed). Finish setup to turn it on:
                    </p>
                  </div>
                  <ol className="flex flex-col gap-2 text-sm text-neutral-600">
                    <li className="flex gap-2">
                      ...
                      <span>
                        Run{' '}
                        <code className="rounded bg-neutral-950/5 px-1 py-0.5 font-mono text-xs text-neutral-950">stripe projects add nitrosend/email</code>
                        {' '}to provision a brand, API key and hosted sender.
                      </span>
                    </li>
                    <li className="flex gap-2">
                      ...
                      <span>
                        Confirm{' '}
                        <code className="rounded bg-neutral-950/5 px-1 py-0.5 font-mono text-xs text-neutral-950">NITROSEND_API_KEY</code>
                        {' '}is in your env with{' '}
                        <code className="rounded bg-neutral-950/5 px-1 py-0.5 font-mono text-xs text-neutral-950">stripe projects env</code>.
                      </span>
                    </li>
                  </ol>
                </div>
